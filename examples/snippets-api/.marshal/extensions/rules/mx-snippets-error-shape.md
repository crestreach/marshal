...
Repo-specific rule promoted by `marshal-learner` during the Learn stage, after the pattern recurred across two changes.
It is `mx-`-prefixed because it is a repo extension, not a built-in MARSHAL rule.
