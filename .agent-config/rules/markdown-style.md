...
- Use **semantic line breaks**: start a new line at sentence
  boundaries (and optionally at major clause boundaries), instead of
  hard-wrapping prose at a fixed column. This keeps diffs small and
  avoids reflow churn when editing. Do not hard-wrap mid-sentence to a
  character limit.
