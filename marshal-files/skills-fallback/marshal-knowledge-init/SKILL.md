...
**Source of truth:** [`marshal-knowledge-curator.md`](../../agents/marshal-knowledge-curator.md) — section for mode `init`. Read it and follow its **Inputs / Workflow / Outputs / Exit criteria / Handoff** sections exactly. Do not duplicate that content here.
