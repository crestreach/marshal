...
**Source of truth:** [`marshal-code-archaeologist.md`](../../agents/marshal-code-archaeologist.md). Read it and follow its **Inputs / Workflow / Outputs / Exit criteria / Handoff** sections exactly. Do not duplicate that content here.
