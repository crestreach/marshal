---
name: marshal-learn
description: MARSHAL Learn stage. Fallback skill for environments without subagent support. Triggers on "merge the phase learnings", "produce learning-rollup.md", "promote learnings into AGENTS.md / rules / skills / agents / knowledge inbox", "draft a new rule / skill / subagent from learnings", "close the loop on this change". Runs learning rollup inline in the current session.
---
