...
- **On result:** hand off to [`marshal-delegate-to-plan`](../marshal-delegate-to-plan/SKILL.md) (stage 4). If new ADRs were drafted, route them through [`marshal-delegate-to-knowledge-maintain`](../marshal-delegate-to-knowledge-maintain/SKILL.md) for promotion into the canonical knowledge tree.
