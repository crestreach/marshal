...
Delegate this to the [`marshal-architect`](../../agents/marshal-architect.md) subagent.
...
If subagents are not available, use [`marshal-architecture`](../../skills-fallback/marshal-architecture/SKILL.md).
Source of truth: [`marshal-architect.md`](../../agents/marshal-architect.md).
