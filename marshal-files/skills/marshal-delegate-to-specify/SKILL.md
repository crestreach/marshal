...
- **On result:** confirm the spec is approved and hand off to [`marshal-delegate-to-intake`](../marshal-delegate-to-intake/SKILL.md) (stage 2) or [`marshal-delegate-to-plan`](../marshal-delegate-to-plan/SKILL.md) (stage 4) per the agreed scope.
